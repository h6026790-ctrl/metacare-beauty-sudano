    ...
    <AppShell>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 py-12 md:grid-cols-2 md:py-20 lg:py-28">
          ...
          >
            ...
            <h1 className="font-display text-4xl leading-[1.05] tracking-tight text-foreground md:text-6xl lg:text-7xl">
              {t.home.heroTitle}
            </h1>
          ...
          <motion.div
            ...
            className="relative aspect-[4/5] max-h-[560px] overflow-hidden rounded-3xl shadow-elevated"
          >
            ...
            <div className="absolute inset-x-4 bottom-4 rounded-2xl glass p-4">
              ...
              <p className="font-display text-lg text-foreground">{products[0].name[lang]}</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <Section title={t.home.featured} link="/products">
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="absolute inset-0 flex flex-col justify-center gap-3 p-6 md:p-12">
            ...
            <Link to="/products" className="mt-2 w-fit rounded-full bg-primary-foreground px-5 py-2.5 text-sm font-medium text-primary">
              {t.home.heroCta}
            </Link>
          </div>
        </div>
      ...
      <Section title={t.home.brands} link="/brands">
        <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
          {brands.map((b) => (
            <Link key={b.id} to="/brands/$id" params={{ id: b.id }}
      ...
      <Section title={t.home.categories} link="/categories">
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          {categories.map((c) => (
            <Link key={c.id} to="/products" search={{ category: c.id }}
